      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <h3 className="text-xl font-bold">Token Assets Insurance</h3>
            <p className="text-muted-foreground">
              Protect your token assets and wallets with our comprehensive all in one wallet insurance plan.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center space-y-4">
            <HomeIcon className="h-12 w-12 text-primary" />
            <h3 className="text-xl font-bold">Property Insurance</h3>
            <p className="text-muted-foreground">
